...
# Form implementation generated from reading ui file 'C:\Users\TomatoTech\Downloads\Endversionen_GUI\GUI_V3_GraphicsView.ui'
#
...
class Ui_MainWindow(GUI_functions):
    def __init__(self):
        ...
        self.Frames.setMinimumSize(QtCore.QSize(50, 20))
        ...
        self.gridLayout.addLayout(self.verticalLayout_15, 0, 0, 3, 1)
        MainWindow.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(MainWindow)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1047, 18))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.graphicsView.setToolTip(_translate("MainWindow", "Video Frames from Camera"))
        self.graphicsView.setStatusTip(_translate("MainWindow", "Frames Feed"))
...
# Control connection of widget from the interface and which functions should be executed
        ...
        # Opening file explorer after triggering Load-Buttons on GUI
        ...
        # Just for trys...
        self.actionLoadDefault.triggered.connect(self.readCustomParametersOutOfFile)
