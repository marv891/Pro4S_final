...
from PyQt5.QtWidgets import QGraphicsOpacityEffect, QApplication, QLabel
...
class Ui_MainWindow(GUI_functions):
    ...
    def __init__(self):
        ...
        self.actionSaveDefault.setObjectName("actionSaveDefault")
        ...
        self.menuInit.addAction(self.actionSaveDefault)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.ReadOffsetButton.setText(_translate("MainWindow", "read Offset manually"))
        ...
        self.actionSaveDefault.setText(_translate("Mainwindow", "Save default"))
        self.actionSave_2.setText(_translate("MainWindow", "Save custom"))
        ...
        self.actionSaveDefault.triggered.connect(self.saveDefaultParametersInFile)
        ...
        # Videostream Enter event
        self.VideoStream.mousePressEvent = self.mousePressed
        self.VideoStream.mouseMoveEvent = self.mouseMoved
        self.VideoStream.mouseReleaseEvent = self.mouseReleased
